...
import { subtleFloat, fadeIn, fadeInUp } from "../../animations";
...
export default function WelcomeScreen({ ctx }: { ctx: NACtx }) {
    ...
    return (
        <Box sx={{
            ...
            {/* Social proof + social links + testimonials */}
            {(socialProofCount > 0 || socialLinks.length > 0 || testimonials.length > 0) && (
                <Box sx={{
                    ...
                    {/* Social proof count — prominent */}
                    {socialProofCount > 0 && (
                        <Box sx={{ display: "flex", alignItems: "baseline", gap: 0.75 }}>
                            <Typography sx={{
                                fontSize: "1.5rem", fontWeight: 700, letterSpacing: "-0.03em",
                                background: `linear-gradient(135deg, ${C.accent}, ${C.gradient2})`,
                                backgroundClip: "text", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
                            }}>
                    ...
                    {/* Testimonials — horizontal compact cards */}
                        ...
                        <Box sx={{
                            ...
                            {testimonials.slice(0, 3).map((t, i) => (
                                <Box key={i} sx={{
                                    ...
                                    px: 2, py: 1.5,
                                    minWidth: 250, flex: "1 1 250px", maxWidth: 320,
                                    borderRadius: "14px",
                                    bgcolor: alpha(C.card, 0.35),
                                    ...
                                    {t.image_url && (
                                        <Box sx={{
                                            ...
                                            border: `2px solid ${alpha(C.accent, 0.12)}`,
                                            flexShrink: 0,
                                        }}>
                                    ...
                                    <Box sx={{ minWidth: 0, flex: 1 }}>
                                        <Box sx={{ display: "flex", alignItems: "center", gap: 0.75, mb: 0.25 }}>
                                            <Typography sx={{
                                                color: alpha(C.text, 0.7), fontSize: "0.72rem",
                                        ...
                                        <Typography sx={{
                                            color: alpha(C.muted, 0.6), fontSize: "0.7rem",
