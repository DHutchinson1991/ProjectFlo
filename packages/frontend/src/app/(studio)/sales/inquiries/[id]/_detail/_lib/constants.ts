...
export const WORKFLOW_PHASES: WorkflowPhase[] = [
    ...
    },
    {
        ...
        icon: CalendarToday,
        color: '#ec4899',
        description: 'Proposal walkthrough and review',
        tasks: ['Prepare Agenda', 'Proposal Review Call', 'Post-Review Summary'],
        sectionId: 'proposal-review-section',
    },
    {
        id: 'quotes',
        name: 'Quotes',
...
const TASK_META: IconMap = {
    ...
    'Consultation Scheduling':    { icon: Schedule,       sectionId: 'proposal-review-section' },
    'Consultation Meeting':       { icon: CalendarToday,  sectionId: 'proposal-review-section' },
    'Proposal Review Scheduling': { icon: Schedule,       sectionId: 'proposal-review-section' },
    'Proposal Review Call':       { icon: CalendarToday,  sectionId: 'proposal-review-section' },
