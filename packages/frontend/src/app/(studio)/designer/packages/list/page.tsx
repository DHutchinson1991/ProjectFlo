...
import { type PackageSet, CATEGORY_COLORS, getCategoryEmoji } from '../_listing';
...
export default function PackageListPage() {
    ...
    // Build a map: packageId → array of { setName, slotLabel }
                    ...
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell sx={headCellSx} align="right">
                                <TableSortLabel
                                    active={sortKey === 'base_price'}
                                    direction={sortKey === 'base_price' ? sortDir : 'asc'}
                            ...
                            <TableCell sx={headCellSx}>
                                <TableSortLabel
                                    active={sortKey === 'set'}
                                    direction={sortKey === 'set' ? sortDir : 'asc'}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell sx={bodyCellSx}>
                                        <Typography sx={{ fontWeight: 700, color: '#f1f5f9', fontSize: '0.85rem', lineHeight: 1.3 }}>
                                            {pkg.name}
                                        </Typography>
                                        {pkg.description && (
                                            <Typography sx={{
                                                color: '#64748b', fontSize: '0.7rem', lineHeight: 1.3,
                                    ...
                                    <TableCell sx={bodyCellSx}>
                                        {pkg.category ? (
                                            <Chip
                                                label={`${getCategoryEmoji(pkg.category)} ${pkg.category}`}
                                                size="small"
                                                sx={{
                                                    height: 22, fontSize: '0.65rem', fontWeight: 700,
                                                    bgcolor: `${catColor}15`, color: catColor,
                                                    border: `1px solid ${catColor}30`,
                                                    borderRadius: 1.5, textTransform: 'uppercase',
                                                    letterSpacing: '0.3px',
                                                }}
                                            />
                                        ) : (
                                    ...
                                    <TableCell sx={bodyCellSx} align="right">
                                        <Typography sx={{
                                            fontWeight: 800, color: '#f59e0b', fontSize: '0.85rem',
                                            fontFamily: 'monospace',
                                        }}>
                                            {formatCurrency(Number(pkg.base_price ?? 0), currencyCode)}
                                        </Typography>
                                    </TableCell>
                                    ...
                                    <TableCell sx={bodyCellSx} align="center">
                                        {pkg.is_active ? (
                                            ...
                                            <CancelIcon sx={{ fontSize: 18, color: '#475569' }} />
                                        )}
                                    </TableCell>
            ...
            >
                ...
                <DialogActions sx={{ px: 3, pb: 2 }}>
                    ...
                    <Button
                        ...
                        variant="contained"
                        sx={{
                            bgcolor: '#ef4444', textTransform: 'none', fontWeight: 700,
