...
import { useSceneSubjects } from "@/hooks/content-builder/scenes";
...
const SceneRecordingSetupModal: React.FC<SceneRecordingSetupModalProps> = ({
    ...
    useFilmSubjects(filmId ?? undefined, currentBrand?.id); // retained for potential future use
    const {
    ...
    const handleAddToLibrary = async () => {
        ...
        try {
            await api.scenes.createTemplateFromScene(primarySceneId, sceneName ?? undefined);
            loadAvailableScenes();
