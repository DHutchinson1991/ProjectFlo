...
export default function CrewPage() {
  ...
  const {
    ...
    queryFn: () => api.paymentBrackets.getAll(true),
  });
  ...
  const {
    ...
    queryFn: () => api.paymentBrackets.getByRole(currentBrand?.id),
    enabled: !!currentBrand,
  });
  ...
  const createMut = useMutation({
    mutationFn: (data: CreatePaymentBracketData) => api.paymentBrackets.create(data),
  ...
  const updateMut = useMutation({
    mutationFn: ({ id, data }: { id: number; data: UpdatePaymentBracketData }) => api.paymentBrackets.update(id, data),
  ...
  const unassignMut = useMutation({
    mutationFn: ({ cId, rId }: { cId: number; rId: number }) => api.paymentBrackets.unassign(cId, rId),
