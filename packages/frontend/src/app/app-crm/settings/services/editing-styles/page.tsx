...
export default function EditingStylesPage() {
            ...
            setStyles([
                {
                    id: 1,
                    name: 'Cinematic',
                    description: 'Cinematic style with smooth transitions and warm colors',
    ...
    const handleMenuClick = (event: React.MouseEvent<HTMLElement>, style: EditingStyle) => {
                            ...
                            <CardContent>
                                ...
                                {style.style_settings && (
                                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5, mb: 2 }}>
                                        {Object.entries(style.style_settings).map(([key, value]) => (
                                            <Chip
                                                key={key}
                                                label={`${key}: ${value}`}
                                                variant="outlined"
