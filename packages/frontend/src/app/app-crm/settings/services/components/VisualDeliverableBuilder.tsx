...
export default function VisualDeliverableBuilder({
  ...
  const handleDragEnd = (result: DropResult) => {
    ...
    if (
      ...
      destination.droppableId === "template-components"
    ) {
      ...
      source.droppableId === "template-components" &&
      destination.droppableId === "template-components"
    ) {
  ...
  const removeComponent = (componentId: string) => {
    const newComponents = template.components.filter(
              ...
              <Droppable droppableId="component-library" isDropDisabled>
                {(provided) => (
                  <Box ref={provided.innerRef} {...provided.droppableProps}>
                    <Stack spacing={1}>
                      {filteredComponents
                        .slice(0, compact ? 4 : filteredComponents.length)
                        .map((component, index) => (
                          <Draggable
                            key={component.id}
                              ...
                              <Box display="flex" alignItems="center" gap={2}>
                                ...
                                <Box
                                  sx={{
                                    ...
                                    borderRadius: 1,
                                    bgcolor:
                                      templateComponent.component?.type ===
                                      "PRODUCTION"
                                        ? "#2196F320"
                                        : "#4CAF5020",
                                    display: "flex",
                                ...
                                >
                                  ...
                                  <Tooltip title="Duplicate component">
                                    <IconButton
                                      onClick={() =>
                                        duplicateComponent(templateComponent.id)
                                      }
                                      color="primary"
                                      size="small"
                                    >
                                  ...
                                  <Tooltip title="Remove component">
                                    <IconButton
                                      onClick={() =>
                                        removeComponent(templateComponent.id)
                                      }
                                      color="error"
                                      size="small"
                                    >
