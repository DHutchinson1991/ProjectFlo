...
interface FilmBuilderExportDialogProps {
    open: boolean;
    onClose: () => void;
...
const FilmBuilderExportDialog: React.FC<FilmBuilderExportDialogProps> = ({
    open,
    onClose,
    onExport,
    componentCount,
            ...
            <DialogContent>
                ...
                <Alert severity="info" sx={{ mb: 3 }}>
                    <Typography variant="body2">
                        ...
                        Components: {componentCount} | Duration: {formatTime(duration)}
                    </Typography>
                </Alert>
                ...
                {selectedFormatInfo && (
                    ...
                    >
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1 }}>
                            ...
                            <Typography variant="subtitle2">{selectedFormatInfo.label}</Typography>
                            <Chip label={selectedFormatInfo.fileSize} size="small" variant="outlined" />
                        </Box>
                        ...
                        {selectedFormat === "json" && (
                            <Typography variant="caption" color="text.secondary" sx={{ mt: 1, display: "block" }}>
                                Includes: Components, tracks, timing, metadata, and template information
                            </Typography>
                        )}
                        {selectedFormat === "csv" && (
                            <Typography variant="caption" color="text.secondary" sx={{ mt: 1, display: "block" }}>
                                Includes: Component name, start time, duration, track, and type data
                            </Typography>
                        )}
                        {selectedFormat === "xml" && (
                            <Typography variant="caption" color="text.secondary" sx={{ mt: 1, display: "block" }}>
...
export default FilmBuilderExportDialog;
