...
import { useMomentOperations } from "@/features/content/moments/hooks";
...
const SceneBlock: React.FC<SceneBlockProps> = ({
    ...
    const handleSceneMomentsUpdate = React.useCallback((updatedMoments: MomentFormData[]) => {
        setLocalMoments(updatedMoments as unknown as MomentWithSetup[]);
