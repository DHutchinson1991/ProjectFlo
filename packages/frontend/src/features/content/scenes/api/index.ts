  ...
  moments: {
    ...
    upsertRecordingSetup: (
      ...
      data: {
        ...
        camera_assignments?: Array<{ track_id: number; subject_ids?: number[]; shot_type?: string | null; shot_coupling?: string | null; enabled?: boolean }>;
        audio_track_ids?: number[];
        audio_assignments?: Array<{ track_id: number; subject_ids?: number[] }>;
        graphics_enabled?: boolean;
        graphics_title?: string | null;
      }
    ): Promise<{ id: number; audio_track_ids: number[]; graphics_enabled: boolean; graphics_title?: string | null; camera_assignments: Array<{ id: number; track_id: number; track_name?: string; track_type?: string; subject_ids?: number[]; shot_type?: string | null; shot_coupling?: string | null; enabled?: boolean }>; audio_assignments?: Array<{ id: number; track_id: number; track_name?: string; subject_ids?: number[] }> }> =>
