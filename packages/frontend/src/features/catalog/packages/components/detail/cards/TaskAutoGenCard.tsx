...
function triggerIcon(type: TriggerType) {
    switch (type) {
        ...
        case TriggerType.PER_CREW: return <PeopleIcon sx={{ fontSize: 12 }} />;
...
function abbreviateRole(name: string): string {
                        ...
                        <>
                            ...
                            <Box>
                                ...
                                <Box
                                    sx={{
                                        display: 'grid',
                                        gridTemplateColumns: '1fr 44px 52px 52px 72px 48px 26px',
                                        gap: 0.5,
                                        px: 1.5, py: 0.75,
                                        mb: 0.5,
                                                        ...
                                                        {(() => {
                                                            ...
                                                            const renderRow = (task: TaskAutoGenerationPreviewTask, key: string, displayName?: string) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <Box sx={{ minWidth: 0 }}>
                                                                        {task.role_name ? (
                                                                            <Tooltip title={`Role: ${task.role_name}`} arrow placement="top">
                                                                                <Chip label={abbreviateRole(task.role_name)} size="small"
                                                                                    sx={{ height: 20, fontSize: '0.6rem', fontWeight: 700, bgcolor: 'rgba(167, 139, 250, 0.12)', color: '#a78bfa', border: '1px solid rgba(167, 139, 250, 0.25)', '& .MuiChip-label': { px: 0.5 }, maxWidth: '100%' }} />
                                                                            </Tooltip>
                                                                    ...
                                                                    <Box sx={{ minWidth: 0 }}>
                                                                        {task.assigned_to_name ? (
                                                                            <Tooltip title={`Assigned to: ${task.assigned_to_name}`} arrow placement="top">
                                                                                <Chip label={abbreviateName(task.assigned_to_name)} size="small"
                                                                                    sx={{ height: 20, fontSize: '0.6rem', fontWeight: 700, bgcolor: 'rgba(34, 211, 238, 0.12)', color: '#22d3ee', border: '1px solid rgba(34, 211, 238, 0.25)', '& .MuiChip-label': { px: 0.5 }, maxWidth: '100%' }} />
                                                                            </Tooltip>
                                                                        ) : <Typography sx={{ fontSize: '0.6rem', color: '#334155' }}>—</Typography>}
                                                                    </Box>
                                                                    ...
                                                                    <Typography sx={{ fontSize: '0.65rem', color: task.onsite_band ? '#f97316' : '#94a3b8', fontWeight: 600, textAlign: 'right', fontVariantNumeric: 'tabular-nums', whiteSpace: 'nowrap' }}>
                                                                        {task.onsite_band
