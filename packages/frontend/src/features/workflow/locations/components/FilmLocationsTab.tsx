...
import { usePackageLocations } from "../hooks/usePackageLocations";
...
export const FilmLocationsTab: React.FC<FilmLocationsTabProps> = ({ filmId, brandId, packageId, activityId }) => {
    ...
    const { slots, eventDays, isLoading: pkgLoading, errorMessage: pkgError } = usePackageLocations(packageId);
