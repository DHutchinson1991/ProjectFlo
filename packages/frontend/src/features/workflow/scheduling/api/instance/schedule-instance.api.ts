...
export function createScheduleInstanceApi(client: ApiClient) {
    return {
        projectEventDays: {
            ...
            create: (projectId: number, data: unknown): Promise<any> =>
                client.post(`/api/schedule/projects/${projectId}/event-days`, data),
            update: (eventDayId: number, data: unknown): Promise<any> =>
        ...
        projectFilms: {
            ...
            upsertSceneSchedule: (projectFilmId: number, data: unknown): Promise<any> =>
                client.post(`/api/schedule/projects/films/${projectFilmId}/scenes`, data),
            bulkUpsertSceneSchedules: (projectFilmId: number, schedules: unknown[]): Promise<any[]> =>
        ...
        inquiryEventDays: {
            ...
            create: (inquiryId: number, data: unknown): Promise<any> =>
        ...
        inquiryFilms: {
            ...
            upsertSceneSchedule: (filmId: number, data: unknown): Promise<any> =>
                client.post(`/api/schedule/projects/films/${filmId}/scenes`, data),
            bulkUpsertSceneSchedules: (filmId: number, schedules: unknown[]): Promise<any[]> =>
        ...
        instanceMoments: {
            ...
            createForProject: (projectId: number, data: unknown): Promise<any> =>
                client.post(`/api/schedule/projects/${projectId}/activity-moments`, data),
            createForInquiry: (inquiryId: number, data: unknown): Promise<any> =>
        ...
        instanceCrewSlots: {
            ...
            update: (slotId: number, data: unknown): Promise<any> =>
                client.patch(`/api/schedule/instance/crew-slots/${slotId}`, data),
            assignCrew: (slotId: number, crewId: number | null): Promise<any> =>
                client.patch(`/api/schedule/instance/crew-slots/${slotId}/assign`, { crew_id: crewId }),
            delete: (slotId: number): Promise<void> =>
        ...
        projectPackageSnapshot: {
            getSummary: (projectId: number): Promise<any> =>
                client.get(`/api/projects/${projectId}/package-snapshot`),
            getEventDays: (projectId: number): Promise<any[]> =>
                client.get(`/api/projects/${projectId}/package-snapshot/event-days`),
            getActivities: (projectId: number): Promise<any[]> =>
                client.get(`/api/projects/${projectId}/package-snapshot/activities`),
            getCrewSlots: (projectId: number): Promise<any[]> =>
                client.get(`/api/projects/${projectId}/package-snapshot/crew-slots`),
            getSubjects: (projectId: number): Promise<any[]> =>
                client.get(`/api/projects/${projectId}/package-snapshot/subjects`),
            getLocations: (projectId: number): Promise<any[]> =>
                client.get(`/api/projects/${projectId}/package-snapshot/locations`),
            getFilms: (projectId: number): Promise<any[]> =>
                client.get(`/api/projects/${projectId}/package-snapshot/films`),
            getActivityMoments: (projectId: number, activityId: number): Promise<any[]> =>
                client.get(`/api/projects/${projectId}/package-snapshot/activities/${activityId}/moments`),
        },

        syncFromPackage: {
            project: (projectId: number): Promise<any> =>
                client.post(`/api/projects/${projectId}/schedule/sync-from-package`, {}),
        ...
        scheduleDiff: {
            project: (projectId: number): Promise<any> =>
                client.get(`/api/projects/${projectId}/schedule/diff`),
            inquiry: (inquiryId: number): Promise<any> =>
