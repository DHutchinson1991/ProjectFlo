export const calendarQueryKeys = {
    ...
    todayEvents: (brandId: number | null | undefined, crewId?: number) =>
        [...calendarQueryKeys.events(brandId), 'today', crewId ?? 'all'] as const,
    upcomingEvents: (brandId: number | null | undefined, crewId?: number, limit = 10) =>
        [...calendarQueryKeys.events(brandId), 'upcoming', crewId ?? 'all', limit] as const,
    ...
    userAccounts: (brandId: number | null | undefined) =>
        [...calendarQueryKeys.byBrand(brandId), 'userAccounts'] as const,
