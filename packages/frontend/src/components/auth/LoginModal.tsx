...
export function LoginModal() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // AuthProvider sets isAuthenticated → ProtectedRoute unmounts this modal
    } catch (err) {
      ...
      >
        ...
        <Box
          sx={{
            p: { xs: 3, sm: 4 },
            borderRadius: "20px",
            // Glass card on top of the blurred overlay
