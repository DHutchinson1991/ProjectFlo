...
import { SubjectsCard } from '@/app/(studio)/designer/packages/[id]/_cards/SubjectsCard';
import { LocationsCard } from '@/app/(studio)/designer/packages/[id]/_cards/LocationsCard';
import { CrewCard } from '@/app/(studio)/designer/packages/[id]/_cards/CrewCard';
