...
const TIER_SKILLS = [
    ...
    // PRODUCER (all level 1 — lowest tier)
    { role: 'producer', level: 1, skill: 'Documentation',      priority: 1 },
    { role: 'producer', level: 1, skill: 'Archiving',          priority: 1 },
    { role: 'producer', level: 1, skill: 'Communication',      priority: 1 },
    { role: 'producer', level: 1, skill: 'Planning',           priority: 1 },
    { role: 'producer', level: 1, skill: 'Scheduling',         priority: 2 },
    { role: 'producer', level: 1, skill: 'Client Relations',   priority: 3 },
    { role: 'producer', level: 1, skill: 'Budget Management',  priority: 2 },
    { role: 'producer', level: 1, skill: 'Vendor Coordination',priority: 2 },
    { role: 'producer', level: 1, skill: 'Presentation',       priority: 2 },
    { role: 'producer', level: 1, skill: 'Project Management', priority: 3 },
    { role: 'producer', level: 1, skill: 'Contract Management',priority: 3 },
    { role: 'producer', level: 1, skill: 'Legal',              priority: 2 },
    { role: 'producer', level: 1, skill: 'Client Delivery',    priority: 2 },
    { role: 'producer', level: 1, skill: 'Consultation',       priority: 3 },
    { role: 'producer', level: 1, skill: 'Sales',              priority: 2 },
    { role: 'producer', level: 1, skill: 'Pricing',            priority: 2 },
    { role: 'producer', level: 1, skill: 'Invoicing',          priority: 1 },
