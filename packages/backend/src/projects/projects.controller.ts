...
export class ProjectsController {
    ...
    async getPackageSnapshot(@Param('id', ParseIntPipe) id: number) {
    ...
    async getPackageSnapshotEventDays(@Param('id', ParseIntPipe) id: number) {
    ...
    async getPackageSnapshotActivities(@Param('id', ParseIntPipe) id: number) {
    ...
    async getPackageSnapshotFilms(@Param('id', ParseIntPipe) id: number) {
    ...
    async syncProjectScheduleFromPackage(@Param('id', ParseIntPipe) id: number) {
